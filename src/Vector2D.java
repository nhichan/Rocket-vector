public class Vector2D {
    ...
    public Vector2D set(float x, float y) {
        this.x = x;
        this.y = y;
        return this; //return chính bản thân Vector2D
    }
    ...
    public Vector2D subtractBy(float x, float y) {
        return this.subtractBy(this.x - x, this.y - y);
    }
...
//subtractBy
//subtract
//multiply(number:)// thay đổi chính nó, return this
//length() độ dài vector
//copy() -> vector mới
//rotate(angle; double) -> vector moi
//normalize() chuẩn hóa, tức sẽ đưa vector thành những vector có độ dài bằng 1// //
